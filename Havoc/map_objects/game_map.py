...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size,max_maze_rooms,maze_min_size, maze_max_size, map_width, map_height, player, entities):
        ...
        down_stairs = Entity(player.x, player.y, '<', libtcod.white, 'Stairs',
    ...
    def place_entities(self, room, entities):
        ...
        max_items_per_room = from_dungeon_level([[0, 0], [1, 4]], self.dungeon_level)
        ...
        item_chances = {
            'healing_potion': 35,
            'sword': from_dungeon_level([[0, 1]], self.dungeon_level),
