        ...
        for i in range(number_of_monsters):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if monster_choice == 'orc':
                    fighter_component = Fighter(hp=20, defense=4, power=6, xp=3005, agility=3)
        ...
        for i in range(number_of_items):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if item_choice == 'healing_potion':
                    ...
                    equippable_component = Equippable(EquipmentSlots.RIGHT_BRACELET, use_function=cast_lightning, defense_bonus=4, agility_bonus=-3)
                    item = Entity(x, y, '[', libtcod.black, 'Right Bracelet of Shock',
