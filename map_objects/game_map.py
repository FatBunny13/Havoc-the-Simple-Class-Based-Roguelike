...
class GameMap:
    ...
    def make_map(self, room_min_size, room_max_size, map_width, map_height,entities,player,max_rooms):
            rooms = []
            num_rooms = 0
            ...
            # random width and height
                w = randint(room_max_size, room_max_size)
    ...
    def place_entities(self, room, entities):
        ...
        monster_chances = {
            ...
            'stone': from_dungeon_level([[25, 2], [40, 4], [75, 4]], self.dungeon_level)}
        ...
        for i in range(number_of_monsters):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if monster_choice == 'orc':
                    ...
                    monster = Entity(x, y, 'f', libtcod.black, 'Fairy', blocks=True,
    ...
    def next_floor(self, player, message_log, constants):
        ...
        self.make_map(constants['max_rooms'], constants['room_min_size'], constants['room_max_size'],
                      ...
                      constants['max_maze_rooms'], constants['maze_min_size'], constants['maze_max_size'], player,entities)
